...
* [Sneat Free Bootstrap HTML Admin Template](https://github.com/themeselection/sneat-html-admin-template-free) - ![stars](https://img.shields.io/github/stars/themeselection/sneat-html-admin-template-free?style=flat-square&cacheSeconds=604800) ![last commit](https://img.shields.io/github/last-commit/themeselection/sneat-html-admin-template-free?style=flat-square&cacheSeconds=86400) Open-source & Easy to use UI Kit and Bootstrap 5 HTML Admin template Dashboard with Elegant Design & Unique Layout. ([demo](https://www.themeselection.com/demo/sneat-bootstrap-html-admin-template-free/html/))
